...
public class NetworkedRunnerMovement : NetworkBehaviour
{
    ...
    private void RotatePlayerMesh()
    {
        ...
        //Vector3 vectOnFloor = Vector3.ProjectOnPlane(CurrentDirectionalInputs, Vector3.up).normalized;
        //Quaternion meshRotation = Quaternion.LookRotation(vectOnFloor, Vector3.up);
        //float interpolationSpeed = 4.0f;
        //RB.rotation = Quaternion.Slerp(RB.rotation, meshRotation, interpolationSpeed * Time.deltaTime);
